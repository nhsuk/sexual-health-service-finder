...
| `AS_INDEX`                         | Name of the [Azure Search Service](https://docs.microsoft.com/en-us/rest/api/searchservice/#calling-the-apis) index used by the application                | organisationlookup-dev    | Yes        |
| `AS_API_KEY`                       | `api-key` for the [Azure Search Service](https://docs.microsoft.com/en-us/rest/api/searchservice/#calling-the-apis)                                        |                           | Yes        |
| `AS_SERVICE_NAME`                  | Name of the [Azure Search Service](https://docs.microsoft.com/en-us/rest/api/searchservice/#calling-the-apis)                                              | nhsuksearchintne-dev      | Yes        |
| `AS_VERSION`                       | Version of the [Azure Search Service](https://docs.microsoft.com/en-us/rest/api/searchservice/#calling-the-apis)                                           | 2017-11-11                | Yes        |
