...
describe('app', () => {
  it('should include required security headers', async () => {
    ...
    expect(res).to.have.header('Content-Security-Policy', 'connect-src \'self\' assets.adobedtm.com *.demdex.net *.google-analytics.com *.hotjar.com:* nhs.funnelback.co.uk; default-src \'self\'; font-src *.hotjar.com *.nhs.uk; frame-src *.hotjar.com; img-src \'self\' data: *.2o7.net *.everesttech.net *.google-analytics.com *.hotjar.com *.nhs.uk *.omtrdc.net *.webtrends.com *.webtrendslive.com; script-src \'self\' \'unsafe-eval\' \'unsafe-inline\' data: assets.adobedtm.com *.demdex.net *.google-analytics.com *.hotjar.com *.nhs.uk *.webtrends.com *.webtrendslive.com; style-src \'self\' \'unsafe-inline\' *.nhs.uk');
